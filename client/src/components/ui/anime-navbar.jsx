            ...
            return (
              ...
              >
                {isActive && (
                  ...
                  >
                    <div className="absolute inset-0 bg-[#4A70A9]/25 rounded-full blur-md" />
                    <div className="absolute inset-[-4px] bg-[#4A70A9]/20 rounded-full blur-xl" />
                    <div className="absolute inset-[-8px] bg-[#4A70A9]/15 rounded-full blur-2xl" />
                    <div className="absolute inset-[-12px] bg-[#4A70A9]/5 rounded-full blur-3xl" />
                    
                    <div 
                      className="absolute inset-0 bg-gradient-to-r from-[#4A70A9]/0 via-[#4A70A9]/20 to-[#4A70A9]/0 animate-shine"
                    />
                  </motion.div>
                )}
                ...
                {isActive && (
                  ...
                  >
                    <div className="relative w-12 h-12">
                      <motion.div 
                        className="absolute w-10 h-10 bg-white rounded-full left-1/2 -translate-x-1/2 flex items-center justify-center shadow-lg"
                        animate={
                          hoveredTab ? {
                            scale: [1, 1.1, 1],
                            rotate: [0, -10, 10, 0],
                      ...
                      >
                        ...
                        >
                          <Plane 
                            size={22} 
                            className="text-[#4A70A9] -rotate-45" 
                            strokeWidth={2}
                          />
                        </motion.div>
                          ...
                          {hoveredTab && (
                            <>
                              ...
                              <motion.div
                                ...
                                className="absolute -bottom-1 -right-2 text-[#4A70A9] text-xs"
                              >
                                ✈️
                              </motion.div>
                            </>
