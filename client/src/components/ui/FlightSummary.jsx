    ...
    <div className="space-y-4 font-sans text-foreground">
      ...
      <div className="bg-card border border-border rounded-xl p-4 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2 mt-3">
           {selectedFlight.isReschedulable && (
             <span className="px-2 py-1 rounded bg-green-500/10 text-green-600 text-[10px] font-bold border border-green-500/20">
      ...
      <div className="bg-card border border-border rounded-xl p-4 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-3 mt-2">
           <div className="flex items-center gap-1">
              <div className="w-3.5 h-3.5 rounded-full bg-yellow-400 text-white flex items-center justify-center font-bold text-[8px] shadow-sm">P</div>
              <span className="text-[10px] text-muted-foreground font-medium">Earn <span className="font-bold text-foreground">{points}</span> Points</span>
           </div>
           <div className="flex items-center gap-1">
              <div className="w-3.5 h-3.5 rounded-full bg-muted-foreground text-card flex items-center justify-center text-[8px]">★</div>
              <span className="text-[10px] text-muted-foreground font-medium">Earn <span className="font-bold text-foreground">{xp}</span> XP</span>
           </div>
        </div>
